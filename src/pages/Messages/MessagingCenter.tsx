...
const MessagingCenter = () => {
  const [activeContact, setActiveContact] = useState<string | null>('1'); // Default to first contact
  ...
  useEffect(() => {
    if (activeContact) {
      setMessages(mockMessages[activeContact as keyof typeof mockMessages] || []);
    }
  }, [activeContact]);
